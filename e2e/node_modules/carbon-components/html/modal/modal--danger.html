...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-sz7fdxztzz8">Show
  modal</button>

<div data-modal id="modal-sz7fdxztzz8" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-sz7fdxztzz8-label" aria-describedby="modal-sz7fdxztzz8-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-sz7fdxztzz8-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-sz7fdxztzz8-heading">Modal heading</p>
