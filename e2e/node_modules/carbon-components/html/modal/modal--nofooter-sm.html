...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-wjbongdm3b">Show
  modal</button>

<div data-modal id="modal-wjbongdm3b" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-wjbongdm3b-label" aria-describedby="modal-wjbongdm3b-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--sm">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-wjbongdm3b-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-wjbongdm3b-heading">Modal heading</p>
