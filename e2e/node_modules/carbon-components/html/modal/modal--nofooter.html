...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-jvvxxip5ae">Show
  modal</button>

<div data-modal id="modal-jvvxxip5ae" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-jvvxxip5ae-label" aria-describedby="modal-jvvxxip5ae-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-jvvxxip5ae-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-jvvxxip5ae-heading">Modal heading</p>
