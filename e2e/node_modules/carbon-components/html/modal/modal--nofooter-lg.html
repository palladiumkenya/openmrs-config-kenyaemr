...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-szmhxqmuqw">Show
  modal</button>

<div data-modal id="modal-szmhxqmuqw" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-szmhxqmuqw-label" aria-describedby="modal-szmhxqmuqw-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-szmhxqmuqw-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-szmhxqmuqw-heading">Modal heading</p>
