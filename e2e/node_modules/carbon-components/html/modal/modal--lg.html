...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-rh1ts66wkuh">Show
  modal</button>

<div data-modal id="modal-rh1ts66wkuh" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-rh1ts66wkuh-label" aria-describedby="modal-rh1ts66wkuh-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--lg">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-rh1ts66wkuh-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-rh1ts66wkuh-heading">Modal heading</p>
