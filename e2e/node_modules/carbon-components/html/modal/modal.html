...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-1086v4cq68n">Show
  modal</button>

<div data-modal id="modal-1086v4cq68n" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-1086v4cq68n-label" aria-describedby="modal-1086v4cq68n-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-1086v4cq68n-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-1086v4cq68n-heading">Modal heading</p>
