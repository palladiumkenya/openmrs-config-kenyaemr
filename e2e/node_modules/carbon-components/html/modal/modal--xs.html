...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-qejzsu12wl8">Show
  modal</button>

<div data-modal id="modal-qejzsu12wl8" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-qejzsu12wl8-label" aria-describedby="modal-qejzsu12wl8-heading" tabindex="-1">
  <div class="bx--modal-container bx--modal-container--xs">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-qejzsu12wl8-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-qejzsu12wl8-heading">Modal heading</p>
