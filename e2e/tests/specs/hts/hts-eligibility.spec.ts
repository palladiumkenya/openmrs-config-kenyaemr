...
const testData = [
  ...
  { gender: "M", age: 10, xpatient: "Patient3" },
  { gender: "F", age: 16, xpatient: "Patient2" },


];

for (const { gender, age, xpatient } of testData) {
  test.describe(`HTS Eligibility Screening Form=${gender}, Age=${age}`, () => {
    ...
    test(`Fill HTS Eligibility Screening Form  ${xpatient}`, async ({
      page,
    }) => {
      ...
      await test.step("Asserting the client health worker question and selecting one of the option", async () => {
        //test.skip(age  < 17 ,'Not applicable');
        if (age > 17) {
      ...
      if (age >= 10 && age < 15) {
        await test.step("Selecting Mother's HIV status", async () => {
          await page.locator("#motHersHivstatusid_0").click();
        });
      }
      ...
      await test.step("Selecting Has the child been defiled as no", async () => {
        if (age < 10) {
          ...
          for (var index = 0; index < elementcount; index++) {
            ...
            if (innerText == "1066AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA") {
              await page.locator('#childDefiledMotherid_1').click();
            }
          }
        }
        if (age < 15 && age >= 10) {
          ...
          for (var index = 0; index < elementcount; index++) {
            ...
            if (innerText == "1066AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA") {
              await page.locator('#childDefiledid_1').click();
            }
          }
        }
      });
      ...
      await test.step("Selecting client ever had sex and validation the questions", async () => {
        if (age >= 15) {
          ...
          for (var index = 0; index < elementcount; index++) {
            ...
            if (innerText == "1") {
              await page.locator('#sexuallyActiveid_0').click();
              await expect(
        ...
        if (age >= 15) {
          ...
          for (var index = 0; index < elementcount; index++) {
            ...
            if (innerText == "1") {
              ...
              await page.locator("#noSexPartnersid").fill("2");
            }
          }
        }
      });
      ...
      await test.step("validating unprotected sex with someone you do not the HIV status reply options and selecting yes", async () => {
        if (age >= 15) {
          ...
          for (var index = 0; index < elementcount; index++) {
            ...
            if (innerText == "1065AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA") {
              await page.locator('#strangerSexid_0').click();
            }
          }
        }
      });
        ...
        if (age < 10) {
          ...
          if (selectedelement !== true) {
            ...
            for (var index = 0; index < elementcount; index++) {
              ...
              if (innerText == "1066AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA") {
                //await element.click();
                await page.locator('#traditionalMethdsid_1').click();
              }
            }
          }
        }
          ...
          if (age <= 10) {
            ...
            if (selectedelement !== true) {
              ...
              for (var index = 0; index < elementcount; index++) {
                ...
                if (innerText == "1066AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA") {
                  await page.locator("#preGnantid_0").click();
                }
              }
            }
          } else {
      ...
      await test.step("Fill if client eligible for testing", async () => {
        ...
        for (var index = 0; index < elementcount; index++) {
          ...
          if (innerText == "1065AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA") {
            await page.locator("#eligibleTestid_0").click();
      ...
      await test.step("Generate the risk Score", async () => {
        ...
        const radios = page.locator("input[type='radio'][name='genRisKid']");
        ...
        await expect(oneIsChecked).toBe(true);
      });
