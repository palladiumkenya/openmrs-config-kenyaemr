...
test('Clinical Encounter Test', async ({ page, api }) => {
    ...
    await test.step('If the patient is above 15 I should fill the family planning section', async () => {
    ...
    await test.step('I Should be able to fill the patient outcome section', async () => {
        ...
        // await page.locator('#admissionWardFemaleid').selectOption('161936AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA'); //add male patients
        // await page.locator('#admissionWardFemaleid').selectOption('161936AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA'); //add child patients
        // await page.locator('#admissionWardFemaleid').selectOption('161936AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA'); //add neonates patients
