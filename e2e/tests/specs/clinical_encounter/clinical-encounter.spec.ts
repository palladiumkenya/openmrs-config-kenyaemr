    ...
    test.describe(`Clinical Encounter Test for Gender=${gender}, Age=${age}`, () => {
        ...
        test('Clinical Encounter Test', async ({ page }) => {
            ...
            await test.step('I should be able to click on the clinical encounter form', async () => {
                await page.getByLabel('forms', { exact: true }).getByText('Clinical Encounter').click();
            ...
            await test.step('When I select other visit types the sections should be visible', async () => {
                await page.getByRole('button', { name: 'Visit Details', exact: true }).click();
            ...
            await test.step('I should be able to fill the presenting complaints section', async () => {
                ...
                await page.locator('#cOmplaIntFieldid').first().selectOption('151AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA');
                await page.locator('#complaintdurationid').first().fill('14');
                await page.locator('#onsetStatusid').first().selectOption('1499AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA');
                await page.getByRole('button', { name: 'Add', exact: true }).click();
            ...
            if(gender === 'F' && age > 14 ) {
                await test.step('If the patient is female and above 14 I should fill the female family planning section', async () => {
                    ...
                    await expect(page.getByText('* If currently using Family').first()).toBeVisible();
                    await page.locator('#fpMethodid').selectOption('160570AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA');

                    await page.locator('#fPlanningid_1').click();
                    await expect(page.locator('#fPlanningid_1')).toBeChecked();
                    await expect(page.getByText('Reason for not using Family').first()).toBeVisible();
                    await page.locator('label').filter({ hasText: /^Not sexually active$/ }).click();
                    await expect(page.locator('label').filter({ hasText: /^Not sexually active$/ })).toBeChecked();
                    // await page.locator('label').filter({ hasText: /^Not sexually active$/ }).click();
                    // await expect(page.locator('label').filter({ hasText: /^Not sexually active$/ })).not.toBeChecked();
                    await page.locator('label').filter({ hasText: /^Thinks can't get pregnant$/ }).click();
                    await expect(page.locator('label').filter({ hasText: /^Thinks can't get pregnant$/ })).toBeChecked();
                    // await page.locator('label').filter({ hasText: /^Thinks can't get pregnant$/ }).click();
                    // await expect(page.locator('label').filter({ hasText: /^Thinks can't get pregnant$/ })).not.toBeChecked();
                    await page.locator('label').filter({ hasText: /^Wants to get pregnant$/ }).click();
                    await expect(page.locator('label').filter({ hasText: /^Wants to get pregnant$/ })).toBeChecked();
                    // await page.locator('label').filter({ hasText: /^Wants to get pregnant$/ }).click();
                    // await expect(page.locator('label').filter({ hasText: /^Wants to get pregnant$/ })).not.toBeChecked();
                    await page.locator('label').filter({ hasText: /^Health Concerns$/ }).click();
                    await expect(page.locator('label').filter({ hasText: /^Health Concerns$/ })).toBeChecked();
                    // await page.locator('label').filter({ hasText: /^Health Concerns$/ }).click();
                    // await expect(page.locator('label').filter({ hasText: /^Health Concerns$/ })).not.toBeChecked();
                    await page.locator('label').filter({ hasText: /^Religious Prohibition$/ }).click();
                    await expect(page.locator('label').filter({ hasText: /^Religious Prohibition$/ })).toBeChecked();
                    // await page.locator('label').filter({ hasText: /^Religious Prohibition$/ }).click();
                    // await expect(page.locator('label').filter({ hasText: /^Religious Prohibition$/ })).not.toBeChecked();
                    await page.locator('label').filter({ hasText: /^Fear of Side Effects$/ }).click();
                    await expect(page.locator('label').filter({ hasText: /^Fear of Side Effects$/ })).toBeChecked();
                    // await page.locator('label').filter({ hasText: /^Fear of Side Effects$/ }).click();
                    // await expect(page.locator('label').filter({ hasText: /^Fear of Side Effects$/ })).not.toBeChecked();
                    await page.locator('label').filter({ hasText: /^Menopause$/ }).click();
                    await expect(page.locator('label').filter({ hasText: /^Menopause$/ })).toBeChecked();
                    // await page.locator('label').filter({ hasText: /^Menopause$/ }).click();
                    // await expect(page.locator('label').filter({ hasText: /^Menopause$/ })).not.toBeChecked();
                    await page.locator('label').filter({ hasText: /^Total abdominal hysterectomy$/ }).click();
                    await expect(page.locator('label').filter({ hasText: /^Total abdominal hysterectomy$/ })).toBeChecked();
                    // await page.locator('label').filter({ hasText: /^Total abdominal hysterectomy$/ }).click();
                    // await expect(page.locator('label').filter({ hasText: /^Total abdominal hysterectomy$/ })).not.toBeChecked();
                    await page.locator('label').filter({ hasText: /^Other$/ }).click();
                    await expect(page.locator('label').filter({ hasText: /^Other$/ })).toBeChecked();
                    // await page.locator('label').filter({ hasText: /^Other$/ }).click();
                    // await expect(page.locator('label').filter({ hasText: /^Other$/ })).not.toBeChecked();
            ...
            await test.step('I should be able to add a final diagnosis', async () => {
                ...
                await page.getByRole('button', { name: 'Remove' }).nth(1).click();
                // await page.getByRole('button', { name: 'Remove' }).click();
                await page.locator('#finalDiagnosiscLinicalNotesid').fill(clinicalNotes)
            });
            ...
            await test.step('When I uncheck the none option, I should be able to fill the section', async () => {
                ...
                await expect(page.locator('label').filter({ hasText: 'Other' }).nth(3)).toBeChecked();
