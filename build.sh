...
npx --legacy-peer-deps openmrs@next build --build-config ./configuration/spa-build-config.json --target ./spa --page-title KenyaEMR
...
cp ${CWD}/assets/favicon.ico ${CWD}/spa
